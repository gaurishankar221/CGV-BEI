# Task 2: Change fixed point to midpoint of the line
...
plt.plot(xt, yt, 'ro--', label="Scaled about midpoint")
plt.legend()
plt.grid(True)
plt.axis('equal')
plt.title("Scaling about Midpoint of Line")
plt.show()